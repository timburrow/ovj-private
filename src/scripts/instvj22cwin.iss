;
; @(#)installvnmrj.iss 19.11 08/04/06 Copyright (c) 2003-2005 Varian, Inc. All Rights Reserved
;
...
AppPublisher=Agilent Technologies
AppPublisherURL=http://www.agilent.com
AppSupportURL=http://www.agilent.com
AppUpdatesURL=http://www.agilent.com
;DefaultDirName={%SFUDIR|C:\SFU}\vnmra
DefaultDirName={code:getDestDir}
DefaultGroupName=VnmrJ
; place installvnmrj.exe into options/code
; OutputDir=../../../options/code
OutputDir=.
...
Name: {commondesktop}\VnmrJ Japanese; Filename: {app}\bin\vnmrj_ja.exe; Tasks: desktopicon; Components: VNMR; WorkingDir: {app}
Name: {commondesktop}\VnmrJ Chinese; Filename: {app}\bin\vnmrj_zh.exe; Tasks: desktopicon; Components: VNMR; WorkingDir: {app}

[Run]

; load.nmr arguments are seperated by COMMAS, each argument needs a comma after it.
Filename: {src}\code\loadnmr.bat; Description: loadnmr; Parameters: {code:GetSourceDir}, win, {code:GetConsoleType}, {code:GetSourceDir}, {code:GetVnmrDir} , {code:GetUserName} , {code:GetGroupName}, {code:GetHomeDir} , {code:GetNmrLnk} , no, {code:GetComponentList} , {code:GetOptionsList}; Tasks: 
;Filename: {src}\code\tclsetup.exe; Components: VNMR; Check: IsTclInstalled

[Components]
Name: VNMR; Description: VNMR; Types: vnmrs datastation; ExtraDiskSpaceRequired: 131817000
Name: Fiddle_Example; Description: Fiddle Example; Types: vnmrs datastation; ExtraDiskSpaceRequired: 392000
Name: Gradient_shim; Description: Gradient shim; Types: vnmrs datastation; ExtraDiskSpaceRequired: 196000
Name: Japanese; Description: Japanese files; Types: vnmrs datastation; ExtraDiskSpaceRequired: 3704000
Name: Chinese; Description: Chinese files; Types: vnmrs datastation; ExtraDiskSpaceRequired: 3704000
Name: Jmol; Description: Jmol; Types: vnmrs datastation; ExtraDiskSpaceRequired: 3536000
Name: JChemPaint; Description: JChemPaint; Types: vnmrs datastation; ExtraDiskSpaceRequired: 7264000
Name: Autotest; Description: Autotest; Types: vnmrs datastation; ExtraDiskSpaceRequired: 2696000

[Types]
Name: datastation; Description: DataStation
...
begin
  ...
  OptionalComponentArray[0] := '768_AS';
...
begin
  ...
  Result := AddBackSlash(DestDir) + 'home';
end;
